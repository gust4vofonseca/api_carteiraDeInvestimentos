...
export class GenerateTables1654092506590 implements MigrationInterface {
    name = 'GenerateTables1654092506590'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "actions" ("id" character varying NOT NULL, "name" character varying NOT NULL, "initials" character varying NOT NULL, "purchaseQuantity" integer NOT NULL, "value" integer NOT NULL, "purchase" boolean NOT NULL, "wallet_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7bfb822f56be449c0b8adbf83cf" PRIMARY KEY ("id"))`);
